...
var server = require('./server/server'),
    deploy = require('./deploy/post'),
    optimize = require('./optimize/index');
...
function createInstance() {
  ...
  soi_instance.server = function() { return server; };
  soi_instance.optimize = function(config, argv) {

  };
  soi_instance.deploy = function(config, argv) {
    deploy(config, argv);
  };
