...
Package.prototype.createFile = function() {
  ...
  var p = this.dist + '/' + (this.noname ? this.hashId + ext : path.basename(this.to));
...
Package.prototype.getHashId = function(replacer) {
  ...
  // 事先无法知道to的具体值，在这里更新
  this.to = soi.utils.normalizeSysPath(path.join(path.dirname(this.to),
        (this.noname ? (this.hashId + path.extname(this.to)) : path.basename(this.to))));
};
