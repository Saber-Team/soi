...
StyleProcessor.prototype.process = function(fileName) {
  ...
  var _path = path.join(this.currentPack.to, basename);
  var to = soi.utils.normalizeSysPath(this.options.domain + path.normalize(_path));
...
StyleProcessor.prototype.getUniqueBundleId = function() {
  this.bundleId = (this.bundleId ? this.bundleId : -1) + 1;
  return 'auto_combined_' + this.bundleId + '.js';
};
