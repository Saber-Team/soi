...
/**
 * Content-Length:283153
 * Content-Type:multipart/form-data; boundary=----WebKitFormBoundarym96vh05aKmmZvuSp
 *
 * ------WebKitFormBoundarym96vh05aKmmZvuSp
 * Content-Disposition: form-data; name="to"
 *
 * aaa
 * ------WebKitFormBoundarym96vh05aKmmZvuSp
 * Content-Disposition: form-data; name="file"; filename="jquery-1.11.1.js"
...
function postFile (fileItem, req) {
  ...
  req.setHeader('Content-Length', contentLength + Buffer.byteLength(endline));
      ...
      files.forEach(function (file) {
        ...
        rest.post(conf.receiver, {
          ...
          data: {
            ...
            to: distPath,
            'tmp_name': rest.file(path.resolve(file), path.basename(file), contentLength)
          },
          timeout: 3000,
          encoding: 'utf8'
