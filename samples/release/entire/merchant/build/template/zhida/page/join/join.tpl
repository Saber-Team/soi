...
<body>
<script type="text/javascript" src="http://zhida.baidu.com:8080/apis/topbar?version=old"></script>
<script type="text/javascript">
...
<div class="framework-page">
    <div class="framework-center" id="main-content">
        <link rel="stylesheet" href="/static/merchant/zhida/css/join/ljQr9F4Oo.css">
        <h1>开通直达号</h1>
        ...
        <script>
            ...
            var FileAPI = {
                debug: true,
                staticPath: 'http://zmike86.zhida.baidu.com:8080/static/merchant/common/swf/'
            };
        </script>
        <script src="/static/merchant/common/js/gfCBDjqUI.js"></script>
        <script src="/static/merchant/common/js/KcSvg2ebF.js"></script>
        <script src="/static/merchant/common/js/oA4foPTQ9.js"></script>
        <script src="/static/merchant/zhida/js/join/K6LFRE6NT.js"></script>
    </div>
</div>
